...
Class NotasFormatar {
   ...
   function calculo1($array_notas, $arredondamento_id) {
        ...
        foreach ($array_notas as $nota) {
            ...
            if ($array_notas_finais[$disciplina_id]['contagem'] == 3 || $array_notas_finais[$disciplina_id]['contagem'] == 4) {
            $array_notas_finais[$disciplina_id]['soma'] += $nota['valor_nota'];
            }
        }
    ...
    protected function arredondamento1($nota_final)
    {
         
    $parte_inteira = (int)$nota_final;

    $parte_decimal = $nota_final - $parte_inteira;
    ...
    {
        $valor_nota_arredondada = round($valor_nota);
